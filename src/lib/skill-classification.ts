...
export const SKILL_CLASSIFICATIONS: Record<string, Classification> = {
  ...
  "frontend-design": { category: "design", model: ["anthropic"] },
  ...
  "webapp-testing": { category: "development", model: ["anthropic"] },
  ...
  "algorithmic-art": { category: "design", model: ["anthropic"] },
  ...
  "replicate-ai-models": { category: "integrations", model: ["universal", "meta", "mistral"] },
